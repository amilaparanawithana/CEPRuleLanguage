System.register(["angular2/core", "../../../services/ui.service"], function(exports_1, context_1) {
    "use strict";
    ...
    return {
        ...
        execute: function() {
            BuilderComponent = (function () {
                function BuilderComponent(uiService) {
                ...
                BuilderComponent.prototype.ngAfterContentInit = function () {
                    ...
                    this.graph.on('change:position', function (cell) {
                        ...
                        links.forEach(function (link) {
                            //xconsole.log(link);
                            if (_.contains(_this.elements, cell))
                    ...
                    var o1 = false, o2 = false; //temp objects to store the links
                ...
                BuilderComponent.prototype.makeSettingsDraggable = function () {
                    $(function () {
                ...
                BuilderComponent.prototype.addIngress = function () {
                    var ingressCopy = this.endPoint.clone();
                    this.graph.addCell(ingressCopy);
                    this.elements.push(ingressCopy);
                };
                BuilderComponent.prototype.addLink = function (obj1, obj2) {
                 ...
                 */
                BuilderComponent.prototype.loadGraph = function (json) {
                    this.graph.fromJSON(JSON.parse(json));
                };
                BuilderComponent.prototype.showSettingsForElement = function (model) {
                 ...
                 */
                BuilderComponent.prototype.saveSettings = function () {
                    this.currentModel.attributes.settings = this.settingsObj;
                    this.cancelSettings();
                };
                BuilderComponent.prototype.cancelSettings = function () {
                    this.currentModel = null;
                    this.settingsObj = {};
                };
                //remove this on deployment
                BuilderComponent.prototype.dump = function () {
                    return JSON.stringify(this.graph);
                };
                BuilderComponent.prototype.dumpSettings = function () {
            ...
            exports_1("BuilderComponent", BuilderComponent);
        }
    }
});
